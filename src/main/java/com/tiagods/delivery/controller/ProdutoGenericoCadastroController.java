...
public class ProdutoGenericoCadastroController extends UtilsController implements Initializable{
    ...
    private Stage stage;
    private ProdutoGenerico produtoGenerico;
    private ProdutosGenericosImpl genericos;
    private ProdutosCategoriasImpl categorias;

    public ProdutoGenericoCadastroController(ProdutoGenerico produtoGenerico, Stage stage) {
        this.stage = stage;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        combos();
        if(produtoGenerico.getId()!=null)
            preencherFormulario(produtoGenerico);
    }
    ...
    void preencherFormulario(ProdutoGenerico produtoGenerico) {
